      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1 }}>
        {currentItem.type === "flight" ? (
          ...
          <>
            <Hotel size={16} />
            <Typography variant="body2">
              {currentItem.status || `Allocating hotel: ${currentItem.name}`}
            </Typography>
          </>
        )}
      </Box>
  ...
  <Box className="p-4 bg-gray-50 rounded mb-4">
    <Grid container spacing={3}>
      <Grid item xs={12} sm={6}>
        ...
        <Typography>
          Name: {traveler.title} {traveler.firstName} {traveler.lastName}
        </Typography>
      ...
      <DialogContent>
        ...
        {allocationComplete &&
          ...
          !error?.includes("go back to itinerary") && (
            <Alert severity="success" sx={{ mb: 3 }} icon={<Check size={20} />}>
              ...
              error?.includes("go back to itinerary") && (
                ...
                >
                  <Alert severity="success">
                    ...
                    <AlertDescription>
                      You can now go back to itinerary to view your updated
                      flights and select seats
                    </AlertDescription>
                  </Alert>
                  <Button
                    variant="contained"
